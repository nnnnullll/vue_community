    ...
    <div>
        ...
        <div class="container">
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
                <el-table-column prop="number" label="单号" width="55" align="center"></el-table-column>
                <el-table-column prop="community" label="社区"></el-table-column>
                <el-table-column prop="household" label="住户"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    // //     this.pageTotal.value = res.pageTotal || 50
    // //   })
    // },
    // // 查询操作
    // handleSearch () {
    ...
    //   })
    //   this.editVisible.value = true
    // },
    // saveEdit () {
    //   this.editVisible.value = false
    //   ElMessage.success(`修改第 ${this.idx + 1} 行成功`)
    //   Object.keys(this.form).forEach((item) => {
    //     this.tableData.value[this.idx][item] = this.form[item]
    //   })
    // }
  }
}
